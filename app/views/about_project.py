...
The aim of the portfolio project is to use the PSG-Audio dataset, which is a freely available open source dataset comprising 212 polysomnograms along with synchronized high-quality tracheal and ambient microphone recordings.
...
""")
st.write("[GitHub repository](https://github.com/Lucamiras/sleep-apnea)")